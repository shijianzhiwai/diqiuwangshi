...
说句题外话，[Rust](https://github.com/rust-lang/rust/blob/master/library/std/src/sys/unix/process/process_unix.rs#L36) 中是使用 `posix_spawn` 和标准方式结合的方式创建进程的，而 Go（1.17）中只使用的标准方式。
